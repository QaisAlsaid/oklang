...
//static ast_expression* parse_assign(parser* p_parser, ast_expression* p_left, precedence p_precedence, bool is_right_associative, token p_trigger);
static ast_expression* parse_binary_infix(parser* p_parser, ast_expression* p_left, precedence p_precedence, bool is_right_associative, token p_trigger);
//static ast_expression* parse_conditional(parser* p_parser, ast_expression* p_left, precedence p_precedence, bool is_right_associative, token p_trigger);
//static ast_expression* parse_as(parser* p_parser, ast_expression* p_left, precedence p_precedence, bool is_right_associative, token p_trigger);

//static ast_expression* parse_unary_postfix(parser* p_parser, ast_expression* p_left, precedence p_precedence, bool is_right_associative, token p_trigger);
//static ast_expression* parse_call(parser* p_parser, ast_expression* p_left, precedence p_precedence, bool is_right_associative, token p_trigger);
//static ast_expression* parse_subscript(parser* p_parser, ast_expression* p_left, precedence p_precedence, bool is_right_associative, token p_trigger);

typedef ast_expression*(*prefix_parse_function)(parser* p_parser, token p_trigger);
typedef ast_expression*(*infix_parse_function)(parser* p_parser, ast_expression* p_left, precedence p_precedence, bool is_right_associative, token p_trigger);
...
ast_expression* parse_binary_infix(parser* p_parser, ast_expression* p_left, precedence p_precedence, bool is_right_associative, token p_trigger) {
  advance(p_parser);
